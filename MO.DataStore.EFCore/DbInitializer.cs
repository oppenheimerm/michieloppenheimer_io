		...
		private static async Task GeneratePosts(MODbContext context)
		{
			var _posts = new Post[]
			{
				...
				new Post {
					...
					PubDate = new DateTime(2019, 11, 30),
					PostCoverPhoto =  "Bayesian-Inference.png"
				},
				new Post {
